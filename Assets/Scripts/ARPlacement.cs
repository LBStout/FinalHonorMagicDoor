...
private Pose placementPose;
    ...
    void Update()
    {
        ...
        {
            Debug.Log("About to place Object");
            ARPlaceObject();
    ...
    {
        // Set the placement pose to be the location of the AR camera  
        // center in the real world and oriented to that surface. 
      ...
      void UpdatePlacementIndicator()
    {
        if (spawnedObject == null && placementPoseIsValid)
        {
            ...
            // Update the placement indicator pose to be 
            // the placement pose. 
        ...
        {
            // Disable the placement indicator so it is 
            // hidden in the scene. 
